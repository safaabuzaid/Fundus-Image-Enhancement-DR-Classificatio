...
clc;clear;close all
addpath('C:\Users\Owner\Desktop\Master\master project\Data\DR');
addpath(genpath(cd));
...
if strcmp(database,'DR')
    load Hard Exudates;load HEmorrhage;load Normal
    data3D = Hard Exudates;        label_gt = Hard Exudates;
    num_Pixel        =   100;
